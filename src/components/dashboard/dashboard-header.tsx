...
interface Props { activeTab: Tab; itemCount: number; onAddItem: () => void; onPhotoUpload: () => void; }
...
export function DashboardHeader({ activeTab, itemCount, onAddItem, onPhotoUpload }: Props) {
